...
const Navbar = () => {
	...
	return (
		<header className='fixed top-0 left-0 w-full Obg-gray-900 bg-opacity-90 backdrop-blur-md shadow-1g z-40 transition-all duration-300 border-b border-orange-800'>
