...
const OrderSummary = () => {
	...
	return (
		<motion.div
			className='space-y-4 rounded-lg border border-orange-700 bg-gray-800 p-4 shadow-sm sm:p-6'
			...
			<div className='space-y-4'>
				...
				<motion.button
					className='flex w-full items-center justify-center rounded-lg bg-orange-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-orange-700 focus:outline-none focus:ring-4 focus:ring-emerald-300'
